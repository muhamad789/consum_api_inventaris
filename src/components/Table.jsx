                                    ...
                                    <td class="px-6 py-4">
...

                                        {
                                            buttonData.includes("permanent-delete") ? (
                                                <a onClick={() => handlePermanetDelete(value.id)} href="#" class="font-medium text-red-600 dark:text-red-500 hover:underline ml-3">Permanen Delete</a>
                                            ) : ''
